...
<!-- Mirrored from technext.github.io/productly/v1.0.0/ by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 20 Feb 2023 09:58:52 GMT -->
...
<head>
    ...
    <!--    Favicons-->
    <!-- ===============================================-->
    <link rel="apple-touch-icon" sizes="180x180" href="{{asset('')}}front_assests/assets/img/favicons/apple-touch-icon.html">
    <link rel="icon" type="image/png" sizes="32x32" href="{{asset('')}}front_assests/assets/img/favicons/favicon-32x32.html">
    <link rel="icon" type="image/png" sizes="16x16" href="{{asset('')}}front_assests/assets/img/favicons/favicon-16x16.html">
    <link rel="shortcut icon" type="image/x-icon" href="{{asset('')}}front_assests/assets/img/favicons/favicon.png">
    <link rel="manifest" href="{{asset('')}}front_assests/icons/manifest.json">
    <meta name="msapplication-TileImage" content="{{asset('')}}front_assests/assets/img/favicons/mstile-150x150.html">
    <meta name="theme-color" content="#ffffff">

    <!-- ===============================================-->
    <!--    Stylesheets-->
    <!-- ===============================================-->
    <link href="{{asset('')}}front_assests/assets/css/theme.min.css" rel="stylesheet" />
  </head>
  ...
  <body>
    ...
    <main class="main" id="top">
      <nav class="navbar navbar-expand-lg navbar-light sticky-top" data-navbar-on-scroll="data-navbar-on-scroll">
        <div class="container"><a class="navbar-brand" href="index-2.html"><img src="{{asset('')}}front_assests/assets/img/logo.svg" height="31" alt="logo" /></a><button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation"><span class="navbar-toggler-icon"> </span></button>
      ...
      <section class="pt-7">
        <div class="container">
          <div class="row align-items-center">
            ...
            <div class="col-md-6 text-end"><img class="pt-7 pt-md-0 img-fluid" src="{{asset('')}}front_assests/assets/img/hero/hero-img.png" alt="" /></div>
          </div>
        </div>
      </section>
      ...
      <section class="pt-5 pt-md-9 mb-6" id="feature">
        ...
        <div class="container">
          ...
          <div class="row">
            <div class="col-lg-3 col-sm-6 mb-2"> <img class="mb-3 ms-n3" src="{{asset('')}}front_assests/assets/img/category/icon1.png" width="75" alt="Feature" />
              <h4 class="mb-3">First click tests</h4>
              <p class="mb-0 fw-medium text-secondary">While most people enjoy casino gambling,</p>
            </div>
            <div class="col-lg-3 col-sm-6 mb-2"> <img class="mb-3 ms-n3" src="{{asset('')}}front_assests/assets/img/category/icon2.png" width="75" alt="Feature" />
            ...
            <div class="col-lg-3 col-sm-6 mb-2"> <img class="mb-3 ms-n3" src="{{asset('')}}front_assests/assets/img/category/icon3.png" width="75" alt="Feature" />
              <h4 class="mb-3">Preference tests</h4>
              <p class="mb-0 fw-medium text-secondary">The Myspace page defines the individual.</p>
            </div>
            <div class="col-lg-3 col-sm-6 mb-2"> <img class="mb-3 ms-n3" src="{{asset('')}}front_assests/assets/img/category/icon4.png" width="75" alt="Feature" />
      ...
      <section class="pt-5" id="validation">
        <div class="container">
          <div class="row">
            ...
            <div class="col-lg-6"><img class="img-fluid" src="{{asset('')}}front_assests/assets/img/validation/validation.png" alt="" /></div>
          </div>
        </div><!-- end of .container-->
      </section><!-- <section> close ============================-->
      <!-- ============================================-->
      ...
      <section class="pt-5" id="manager">
        <div class="container">
          <div class="row">
            <div class="col-lg-6"><img class="img-fluid" src="{{asset('')}}front_assests/assets/img/manager/manager.png" alt="" /></div>
            <div class="col-lg-6">
              <h5 class="text-secondary">Easier decision making for</h5>
              <p class="fs-7 fw-bold mb-2">Product Managers</p>
              <p class="mb-4 fw-medium text-secondary">The Myspace page defines the individual,his or her
                characteristics, traits, personal choices and the overall<br />personality of the person.</p>
              <div class="d-flex align-items-center mb-3"> <img class="me-sm-4 me-2" src="{{asset('')}}front_assests/assets/img/manager/tick.png" width="35" alt="tick" />
      ...
      <section class="pt-5" id="marketer">
        <div class="container">
          <div class="row">
            ...
            <div class="col-lg-6"><img class="img-fluid" src="{{asset('')}}front_assests/assets/img/marketer/marketer.png" alt="" /></div>
          </div>
        </div><!-- end of .container-->
      </section><!-- <section> close ============================-->
      <!-- ============================================-->
        ...
        <div class="container">
          ...
          <div class="row">
            <div class="col-md-4 mb-4">
              <div class="card"><img class="card-img-top" src="{{asset('')}}front_assests/assets/img/marketing/marketing01.png" alt="" />
            ...
            <div class="col-md-4 mb-4">
              <div class="card"><img class="card-img-top" src="{{asset('')}}front_assests/assets/img/marketing/marketing02.png" alt="" />
                <div class="card-body ps-0">
                  <p class="text-secondary">By <a class="fw-bold text-decoration-none me-1" href="#">Abdullah</a>|<span class="ms-1">03 March 2019</span></p>
            ...
            <div class="col-md-4 mb-4">
              <div class="card"><img class="card-img-top" src="{{asset('')}}front_assests/assets/img/marketing/marketing03.png" alt="" />
                <div class="card-body ps-0">
                  <p class="text-secondary">By <a class="fw-bold text-decoration-none me-1" href="#">Abdullah</a>|<span class="ms-1">03 March 2019</span></p>
      ...
      <section class="pb-2 pb-lg-5">
        <div class="container">
          <div class="row border-top border-top-secondary pt-7">
            <div class="col-lg-3 col-md-6 mb-4 mb-md-6 mb-lg-0 mb-sm-2 order-1 order-md-1 order-lg-1"><img class="mb-4" src="{{asset('')}}front_assests/assets/img/logo.svg" width="184" alt="" /></div>
    ...
    <div class="modal fade" id="popupVideo" tabindex="-1" aria-labelledby="popupVideo" aria-hidden="true">
      <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content"> <iframe class="rounded" style="width:100%;height:500px;" src="https://www.youtube.com/embed/_lhdhL4UDIo" title="YouTube video player" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></div>
      </div>
    </div>
    ...
    <!--    JavaScripts-->
    <!-- ===============================================-->
    <script src="{{asset('')}}front_assests/vendors/%40popperjs/popper.min.js"></script>
    <script src="{{asset('')}}front_assests/vendors/bootstrap/bootstrap.min.js"></script>
    <script src="{{asset('')}}front_assests/vendors/is/is.min.js"></script>
    <script src="https://polyfill.io/v3/polyfill.min58be.js?features=window.scroll"></script>
    <script src="{{asset('')}}front_assests/vendors/fontawesome/all.min.js"></script>
    <script src="{{asset('')}}front_assests/assets/js/theme.js"></script>
    <link href="https://fonts.googleapis.com/css2?family=Poppins:wght@400;500;600;700&amp;family=Volkhov:wght@700&amp;display=swap" rel="stylesheet">
  </body>


<!-- Mirrored from technext.github.io/productly/v1.0.0/ by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 20 Feb 2023 09:59:02 GMT -->
</html>